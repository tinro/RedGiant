#ifndef REDGIANT_CONCURRENCY_THREAD_POOL_EXECUTOR_H_
#define REDGIANT_CONCURRENCY_THREAD_POOL_EXECUTOR_H_
...
#endif /* REDGIANT_CONCURRENCY_THREAD_POOL_EXECUTOR_H_ */
