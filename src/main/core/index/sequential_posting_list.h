#ifndef REDGIANT_CORE_INDEX_STATIC_POSTING_LIST_H_
#define REDGIANT_CORE_INDEX_SEQUENTIAL_POSTING_LIST_H_
...
#endif /* REDGIANT_CORE_INDEX_STATIC_POSTING_LIST_H_ */
