#ifndef SRC_MAIN_REDGIANT_CORE_INDEX_MAP_POSTING_LIST_H_
#define SRC_MAIN_REDGIANT_CORE_INDEX_MAP_POSTING_LIST_H_
...
#endif /* SRC_MAIN_REDGIANT_CORE_INDEX_MAP_POSTING_LIST_H_ */
